    ...
    cs: [
      {
        ...
        answers: [
          {
            answer: 'الكمبيوتر هو ليس جهاز بل هو الة حاسبة سريعة فقط',
            trueAnswer: false,
          },
          {
            answer:
              'الكمبيوتر هو جهاز إلكتروني قابل للبرمجة مصمم لأخذ البيانات، معالجتها، وتوفير معلومات ذات معنى',
            trueAnswer: true,
          },
          {
            answer:
              'الكمبيوتر هو جهاز غير قابل للبرمجة ولكن مصمم لمعالجة البيانات وتوفير معلومات ذات معنى',
            trueAnswer: false,
          },
        ],
      },
